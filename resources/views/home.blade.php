...
@section('content')
        ...
        <div class="bg-white py-6 mb-24">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="sm:text-center">
                    ...
                    <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">A better way to manage
                        school
                        students</p>
                    <p class="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-600">By using our student management
                        system,
                ...
                <div class="mt-20 max-w-lg sm:mx-auto md:max-w-none">
                    <div class="grid grid-cols-1 gap-y-16 md:grid-cols-2 md:gap-x-12 md:gap-y-16">
                        <div class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
                            ...
                            <div class="sm:min-w-0 sm:flex-1">
                                <p class="text-lg font-semibold leading-8 text-gray-900">Easy and fast management of student
                                    data</p>
                                <p class="mt-2 text-base leading-7 text-gray-600">Easy and fast student data management with
                                    our
                                    system. Intuitive navigation, user-friendly interface, and quick search/update
                                    capabilities.
                        ...
                        <div class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
                            ...
                            <div class="sm:min-w-0 sm:flex-1">
                                <p class="text-lg font-semibold leading-8 text-gray-900">Efficient communication with
                                    students
                                </p>
                                <p class="mt-2 text-base leading-7 text-gray-600">Comprehensive student data analysis with
                                    our
                        ...
                        <div class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
                            ...
                            <div class="sm:min-w-0 sm:flex-1">
                                <p class="text-lg font-semibold leading-8 text-gray-900">Comprehensive student data
                                    analysis
                                </p>
                                <p class="mt-2 text-base leading-7 text-gray-600">Our student management system offers
                                    comprehensive student data analysis, giving you the ability to track student performance
                                    and
                        ...
                        <div class="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
                            ...
                            <div class="sm:min-w-0 sm:flex-1">
                                ...
                                <p class="mt-2 text-base leading-7 text-gray-600">Our system offers 24/7 support from our
                                    dedicated and experienced team, ensuring that you have access to assistance with any
                                    issues
        ...
        <section class="bg-white">
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 text-black">Contact Us
                </h2>
                <p class="mb-8 lg:mb-16 font-medium text-center text-gray-700  sm:text-xl">Got a technical issue? Want to
                    send
